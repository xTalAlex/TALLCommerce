<div>
    <div class="">
        <x-button class="h-6 px-1 py-1 btn-error" wire:click="$toggle('confirmingReviewDeletion')" wire:loading.attr="disabled">
    ...
    <x-jet-dialog-modal wire:model="confirmingReviewDeletion">
        ...
        <x-slot name="footer">
            <x-button wire:click="$toggle('confirmingReviewDeletion')" wire:loading.attr="disabled">
                {{ __('Cancel') }}
            </x-button>

            <x-button class="ml-2 btn-error" wire:click="deleteReview" wire:loading.attr="disabled">
                {{ __('Confirm') }}
            </x-button>
        </x-slot>
    </x-jet-dialog-modal>
