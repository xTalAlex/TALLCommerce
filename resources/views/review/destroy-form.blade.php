<div>
    <div class="mt-5">
        <x-jet-danger-button wire:click="$toggle('confirmingReviewDeletion')" wire:loading.attr="disabled">
            <x-icons.trash/>
        </x-jet-danger-button>
    ...
    <x-jet-confirmation-modal wire:model="confirmingReviewDeletion">
        ...
        <x-slot name="footer">
            <x-jet-secondary-button wire:click="$toggle('confirmingReviewDeletion')" wire:loading.attr="disabled">
                {{ __('Cancel') }}
            </x-jet-secondary-button>

            <x-jet-danger-button class="ml-2" wire:click="deleteReview" wire:loading.attr="disabled">
                {{ __('Confirm') }}
            </x-jet-danger-button>
        </x-slot>
