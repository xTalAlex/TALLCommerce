            ...
            <div class="relative border-b border-gray-200">
                ...
                >
                    ...
                    <div class="py-6 space-y-2">
                        <x-input @class(['hidden' => Auth::check()]) label="{{ __('Email') }}" name="email" wire:model.lazy="order.email"/>
                        <div class="grid gap-2 xl:grid-cols-2 xl:gap-6">
                            ...
                            <x-input label="{{ __('Phone Number') }}" name="phone" wire:model.lazy="order.phone"/>
                        </div>
            ...
            <div class="relative border-b border-gray-200">
                ...
                >
                    ...
                    <div class="py-6 space-y-2">
                        ...
                        <div class="grid gap-2 xl:grid-cols-2 xl:gap-6">
                            <x-input label="{{ __('Fiscal Code') }}" name="fiscal_code" wire:model.lazy="order.fiscal_code"/>  
                            <x-input label="{{ __('VAT') }}" name="vat" wire:model.lazy="order.vat"/>  
                        </div>
                        <div>
