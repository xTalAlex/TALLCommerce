<div>
    <div class="">
        <x-danger-button class="w-full text-center" wire:click="$toggle('confirmingOrderDeletion')" wire:loading.attr="disabled">
            {{ __('Cancel') }}
        </x-danger-button>
    ...
    <x-jet-confirmation-modal wire:model="confirmingOrderDeletion">
        ...
        <x-slot name="footer">
            ...
            <x-danger-button class="ml-2" wire:click="deleteOrder" wire:loading.attr="disabled">
                {{ __('Confirm') }}
            </x-danger-button>
        </x-slot>
