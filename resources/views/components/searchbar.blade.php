...
>
  <div class="container flex flex-wrap items-end justify-between mx-auto">
    <div>
        ...
        >
          <option value="default" @if(!request()->orderby || request()->orderby=="default" ) selected @endif>Most Recent
          </option>
          <option value="price_asc" @if(request()->orderby=="price_asc" ) selected @endif>Ascending Price
          </option>
          <option value="price_desc" @if(request()->orderby=="price_desc" ) selected @endif>Descending Price
          </option> 
        </select>
    </div>
    <div class="flex">
